CREATE OR REFRESH STREAMING LIVE TABLE lakehouse_imersao_jornada.bronze.bitcoin
...
SELECT *
FROM cloud_files(
  '/Volumes/lakehouse_imersao_jornada/raw/coinbase/coinbase/bitcoin_spot/',  -- caminho de origem
  'json',                                                   -- formato
  map(
